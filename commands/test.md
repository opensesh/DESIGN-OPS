...
1. Remove deleted Figma project: `/dcs:configure` → Design → Figma
2. Connect Substack for full analytics: `/dcs:add-tool substack`
```
...
**Fix:** Run `/dcs:configure` → Design → Figma → Update token
```
